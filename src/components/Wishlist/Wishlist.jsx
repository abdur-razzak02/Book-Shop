          ...
          >
            ...
            <div className="flex justify-between items-center w-full gap-1">
              <div className="sm:space-y-1">
                ...
                <h1 className="font-semibold text-[12px] sm:text-base">
                  Price: {product.price}$
                </h1>
                <button
                  onClick={() => handelAddToCart(product.product_id, product)}
                  className="bg-[#9538E2] py-1 sm:py-2 px-3 sm:px-5 rounded-full border text-white flex items-center gap-2 text-[12px] sm:text-base"
                >
